    ...
    function switchLanguage(lang) {
        ...
        if (projectCards.length >= 5) {
            ...
            if (projectCards.length >= 9) {
                const p9Title = projectCards[8].querySelector('h3');
                const p9Subtitle = projectCards[8].querySelector('.project-subtitle');
                const p9Desc = projectCards[8].querySelector('.project-description');
                const p9Result = projectCards[8].querySelector('.project-result');
                if (p9Title) p9Title.textContent = t.project9Title;
